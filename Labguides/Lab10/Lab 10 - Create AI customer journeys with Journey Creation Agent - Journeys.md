...
1.  Sign in and navigate to the Customer Insights – Journeys portal. The Welcome to real-time journeys home page opens, showing quick start tiles for creating emails, journeys, and text messages.

![Real-time journeys home page](./media/image1.png "Real-time journeys home page")

2.  In the left-hand navigation, select **Settings**, then choose AI hub to open the area where AI agents are managed.

![Settings menu with AI hub highlighted](./media/image2.png "Settings menu with AI hub highlighted")
...
![Agent manager
prerequisites](./media/image3.png "Agent manager prerequisites")
...
![Add an AI agent dialog](./media/image4.png "Add an AI agent dialog")
...
![Journey Creation Agent overview](./media/image5.png "Journey Creation Agent overview")
...
tab](./media/image6.png "Journey Creation Agent prerequisites tab")
...
tab](./media/image7.png "Journey Creation Agent settings tab")

7. A confirmation dialog appears once the agent is ready. Select **Got it**, to close it.

![Agent enabled confirmation
dialog](./media/image8.png "Agent enabled confirmation dialog")
...
enabled](./media/image9.png "AI agents list showing Journey Creation Agent enabled")
...
![Power Apps home page with Apps highlighted](./media/image10.png "Power Apps home page with Apps highlighted")
...
highlighted](./media/image11.png "Apps list with Customer Insights - Journeys edit icon highlighted")
...
![All Journeys list in the app](./media/image12.png "All Journeys list in the app")
...
![All Segments view](./media/image13.png "All Segments view")

2. Select **New Segment** to open the segment creation pane.

![New segment dialog](./media/image14.png "New segment dialog")

3. Name the new segment **New Customers - Welcome Campaign** and select **Lead** from the Select a target audience drop-down list.

![Naming the segment and choosing target audience](./media/image15.png "Naming the segment and choosing target audience")
...
![Create new journey dialog with Journey Creation Agent tab](./media/image17.png "Create new journey dialog with Journey Creation Agent tab")
...
![Prompt entered in Journey Creation Agent](./media/image18.png "Prompt entered in Journey Creation Agent")
...
![Generated journey canvas with Welcome Email, Wait, and Exclusive Offer steps](./media/image19.png "Generated journey canvas with Welcome Email, Wait, and Exclusive Offer steps")
...
![Generated journey canvas with Welcome Email, Wait, and Exclusive Offer steps](./media/image20.png "Generated journey canvas with Welcome Email, Wait, and Exclusive Offer steps")

2. When the confirmation dialog appears, select **Skip or Tell me more** to close it.

![Journey published confirmation dialog](./media/image21.png "Journey published confirmation dialog")
...
status](./media/image22.png "Published journey showing Live status")
