...
Configure the following settings on the **Immersive** **settings** tab: Configure Workload Prompt:
...
1.  From the **Copilot Service admin center** menu, select **Copilot Service workspace**.

    ![](./media/image24.png)

2.  Select the **Copilot service workspace**.

    ![](./media/image25.png)

3.  Select the **Customer Service Representative Dashboard**.
...
4.  Select one of the cases listed on the **Customer Service Representative Dashboard**. For example, **A Mineral Build Up in Water Supply**.

    ![](./media/image28.png)

5.  The **Case summary** appears as a card on the case form. When you open a case, the **Summary** card collapses by default.

    ![](./media/image29.png)

6.  Expand the **Summary** tab.

    ![](./media/image30.png)

7. You can see the generated case summary.
...
2.  Select your lab environment as **Customer Service Trial**.
