...
Set up the Microsoft 365 and Power Platform environment for **Dynamics 365  Customer Service** and explore key **Copilot and AI-assisted capabilities** for case management, customer communication, knowledge creation, and data insights.

## **Objective**

- Assign and activate the required Power Apps and Dynamics 365 Customer Service trial licenses.

- Enable and configure Copilot in the Dynamics 365 Customer Service Admin Center.

- Use Copilot to summarize cases, answer case-related questions, and draft customer emails.

- Explore Copilot-powered AI capabilities, including form-fill assistance, natural language search, row summaries, and timeline highlights.
...
**Conclusion:** 
You have enabled and configured Copilot for Dynamics 365 Customer Service, including case summaries, immersive settings, email assistance, and prompts, completing the setup needed before working with Copilot in the exercises that follow.
...
**Conclusion** 
You have seen how Copilot automatically summarizes key
case details such as the customer, subject, product, priority, and description, helping representatives quickly understand a case without reading through every field.

### Task 2: Ask Questions About Case Data

In this exercise, you will use the Copilot pane to ask natural-languagequestions about a case, review Copilot's answers and sources, and refine responses through follow-up questions.
...
**Conclusion:** You have practiced asking direct and follow-up questions in Copilot, reviewing its sourced answers, rating responses, and sending Copilot-assisted replies to customers, demonstrating how Copilot supports faster and more informed case resolution.
...
**Conclusion:** You have generated a draft customer email using
**Copilot's** predefined prompts, customized its tone and length, and
copied the result into an activity, showing how Copilot speeds up
customer email communication.

### Task 4: Generate knowledge drafts

In this exercise, use **Copilot** to generate a structured knowledge
article draft from a resolved case. Review and refine the **Title,
Issue, Cause, and Resolution** before creating the knowledge proposal.
...
**Conclusion:** Copilot's ability to work across multiple languages
means representatives can support a global customer base without needing
separate tools or manual translation.
...
**Conclusion:** You have enabled and tested **AI Form Fill Assistance**,
including inline suggestions and file-based form fill, showing how
Copilot can help representatives populate case records faster and with
...
**Conclusion:** 
You have configured and viewed a Copilot-generated row summary, giving representatives a quick, AI-generated overview of a record's key details directly from the Insights bar.
...
**Conclusion:** 
You have generated timeline highlights for a case,
showing how Copilot can condense a record's activity history into a quick, scannable summary for representatives.
