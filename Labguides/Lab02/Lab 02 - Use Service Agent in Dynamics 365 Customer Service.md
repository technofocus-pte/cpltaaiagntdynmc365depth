...
In this lab, you'll explore **Service Agent in Dynamics 365 Customer Service** and learn how it helps customer service representatives efficiently manage customer cases. You'll use Service Agent to review cases, generate summaries, identify next steps, retrieve knowledge articles, draft responses, and update case records using natural language.

### **Objective**

- By the end of this lab, you will be able to:

- Access and use Service Agent in Dynamics 365 Customer Service.

- Review and prioritize customer cases using AI-powered assistance.

- Generate summaries of cases and customer interactions.

- Retrieve relevant knowledge articles and recommendations.

- Update case information using natural language prompts.

- Create follow-up activities and child cases to improve customer
  support efficiency.
...
**Conclusion:** You have successfully activated the Customer Service trial and verified that the Customer Service Trial environment is available, giving you access to the Copilot Service workspace used throughout the rest of this lab.
...
13. Go to the Prompts tab, leave all currently checked prompts enabled.
    Click **Save**.
...
**Conclusion:** You have enabled and configured Copilot for Dynamics 365 Customer Service, including case summaries, immersive settings, email assistance, and prompts, completing the setup needed before working with Copilot in the exercises that follow.
...
**Conclusion**: The Service app is successfully installed and available on Microsoft 365 Copilot.
...
**Conclusion**: Service Agent analyzes available cases and identifies cases that require additional action or follow-up.
...
Conclusion: **Service Agent generates a concise summary of the history, activities, and current status.**
...
**Conclusion:** Service Agent summarizes recent customer interactions and provides relevant communication history.
...
- Case priority is updated.

- Notes are added to the case.

- A child case is created and associated with the parent case.

## **Summary**

In this lab, you used **Service Agent** in **Dynamics 365 Customer Service** to improve customer support operations. You learned how to access **Service Agent**, review customer cases, generate AI-powered summaries, analyse customer interactions, retrieve relevant knowledge articles, and perform case updates using natural language prompts.
